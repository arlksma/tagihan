...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO transaksi (id_transaksi, id_pelanggan, id_paket, tanggal_berlangganan) VALUES ('$id_transaksi', '$id_pelanggan', '$id_paket', '$tanggal_berlangganan')";
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="email-horizontal" class="form-control" name="id_transaksi" placeholder="id_transaksi">
                            </div>
                            <div class="col-md-4">
                                <form action="" method="POST">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="date" id="contact-info-horizontal" class="form-control" name="tanggal_berlangganan" placeholder="tanggal_berlangganan">
